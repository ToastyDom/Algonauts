    ...
    function ($scope, $log, $timeout, $http, $sce, $mdSidenav, angularGridInstance) {
        ...
        $scope.members = [
            ...
            },
            {
                ...
                url: "https://kshitijd20.github.io/",
                photo: "kshitij.jpg",
        ...
        $scope.eventPlanners = [
            ...
            {
                name: "Fern Keniston",
                url: "http://web.mit.edu/fernd/www/",
                photo: "fern.jpg",
                affiliation: "Program Coordinator and Assistant to the Directors, MIT"
            },
            {
                name: "Kim Martineau",
                url: "https://www.linkedin.com/in/kmartineau/",
                photo: "kim.jpg",
                affiliation: "Communications Officer, MIT"
            },
            {
                name: "Samantha Smiley",
                url: "https://mitibmwatsonailab.mit.edu/people/samantha-smiley/",
                photo: "sam.jpg",
                affiliation: "Administrative Assistant, MIT"
            }
        ];
        ...
        $scope.speakers = [
            ...
            },
            {
                ...
                url: "https://zuckermaninstitute.columbia.edu/nikolaus-kriegeskorte-phd",
                photo: "nikolaus.jpg",
            ...
            },
            {
                ...
                url: "https://mohsenzadehlab.com/",
                photo: "yalda.jpg",
                affiliation: "MIT, Western University"
            },
            {
            ...
            },
            {
                ...
                url: "http://www.cvai.cs.uni-frankfurt.de/",
                photo: "gemma.jpg",
                affiliation: "SUTD" // Singapore University of Technology and Design //SUTD
            }
            // {
            //     name: "",
            //     url: "",
        ...
        $scope.coreMembers2020 = [
            {
                name: "Team Leader: Radoslaw Cichy",
                url: "http://userpage.fu-berlin.de/rmcichy/",
                photo: "radek.png",
                affiliation: "Professor, Freie Universität Berlin"
            },
            {
                name: "Team Leader: Aude Oliva",
                url: "http://olivalab.mit.edu/",
                photo: "aude2023.jpg",
                affiliation: "MIT Senior Research Scientist, MIT Director MIT-IBM Watson AI Lab"
            },
            {
                name: "Team Leader: Gemma Roig",
                url: "http://www.cvai.cs.uni-frankfurt.de/",
                photo: "gemma.jpg",
                affiliation: "Assistant Professor, Goethe University Frankfurt" // Singapore University of Technology and Design //SUTD
            }
        ...
        $scope.members2020 = [
            ...
            },
            {
                ...
                url: "https://kshitijd20.github.io/",
                photo: "kshitij.jpg",
                affiliation: "PhD Student, GU Frankfurt" // Singapore University of Technology and Design 
            },
            {
                name: "Monika Graumann",
                url: "https://www.ewi-psy.fu-berlin.de/en/einrichtungen/arbeitsbereiche/neural_dyn_of_vis_cog/team_v2/pre_docs/m_graumann/index.html",
                photo: "monika.jpg",
                affiliation: "PhD Student, FU Berlin"
            },
            {
                name: "Polina Iamshchinina",
                url: "https://www.ewi-psy.fu-berlin.de/en/einrichtungen/arbeitsbereiche/neural_dyn_of_vis_cog/team_v2/pre_docs/p_iamschchinina/index.html",
                photo: "polina.jpg",
                affiliation: "PhD Student, FU Berlin"
            },
            {
                ...
                url: "http://cvnlab.net",
                photo: "kendrick.jpg",
                affiliation: "Assistant Professor, UMN"
            },
            {
                name: "Benjamin Lahner",
                url: "https://www.linkedin.com/in/benlahner/",
            ...
            {
                name: "Ratan Murty",
                url: "http://ratan.mit.edu/",
                photo: "ratan.jpg",
                affiliation: "Postdoc, MIT"
            },
            //{
            //    name: "Yalda Mohsenzadeh",
            //    url: "https://mohsenzadehlab.com/",
        ...
        $scope.coreMembers2023 = [
            ...
            },
            {
                ...
                url: "http://www.cvai.cs.uni-frankfurt.de/",
                photo: "gemma.jpg",
                affiliation: "Assistant Professor, Goethe University Frankfurt"
            }
        ...
        $scope.members2023 = [
            {
                name: "Alessandro Gifford",
                url: "https://www.ewi-psy.fu-berlin.de/en/einrichtungen/arbeitsbereiche/neural_dyn_of_vis_cog/team_v2/pre_docs/A_Gifford/index.html",
                photo: "alessandro_gifford.png",
                affiliation: "PhD Student, Freie Universität Berlin"
            },
            {
                name: "Benjamin Lahner",
                url: "https://www.linkedin.com/in/benlahner/",
            ...
            },
            {
                name: "Alex Lascelles",
                url: "https://www.linkedin.com/in/alexlascelles/",
                photo: "alex_lascelles.jpg",
                affiliation: "Research Assistant, MIT"
            },
            {
                name: "Sari Saba-Sadiya",
                url: "https://sari-saba-sadiya.github.io/",
                photo: "sari512.jpg",
                affiliation: "Postdoc, Goethe University Frankfurt"
            },
            {
                name: "Martina Vilas",
                url: "https://martinagvilas.github.io/",
                photo: "martina_vilas.png",
                affiliation: "PhD Student, Goethe University Frankfurt and ESI"
            }
        ];
...
// ULTIMATE METADATA LEADERBOARD!!!!!!

        //fMRI - TS1
        $http.get('../../../metadata/jsons/submissions_fmri_leaderboard_TS1_rankby_score_pc.json').then(
            function (response) {
                // console.log('got json response')
                $scope.data = response.data;
                console.log('fmri TS1 response.data  =',response.data);
                $scope.lb_fmri_ts1 = response.data//$scope.csv_parse_fmri(response.data);
            },
            function (response) {
                // called asynchronously if an error occurs
                // or server returns response with an error status.
        ...
        //fMRI - TS2
        $http.get('../../../metadata/jsons/submissions_fmri_leaderboard_TS2_rankby_score_pc.json').then(
            function (response) {
                // console.log('got json response')
                $scope.data = response.data;
                console.log('fmri TS2 response.data  =',response.data);
                $scope.lb_fmri_ts2 = response.data//$scope.csv_parse_fmri(response.data); 
            },
            function (response) {
                // called asynchronously if an error occurs
                // or server returns response with an error status.
        ...
        //MEG - TS1
        $http.get('../../../metadata/jsons/submissions_meg_leaderboard_TS1_rankby_score_pc.json').then(
            function (response) {
                // console.log('got json response')
                $scope.data = response.data;
                console.log('fmri TS1 response.data  =',response.data);
                $scope.lb_meg_ts1 = response.data//$scope.csv_parse_fmri(response.data);
            },
            function (response) {
                // called asynchronously if an error occurs
                // or server returns response with an error status.
        ...
        //MEG - TS2
        $http.get('../../../metadata/jsons/submissions_meg_leaderboard_TS2_rankby_score_pc.json').then(
            function (response) {
                // console.log('got json response')
                $scope.data = response.data;
                console.log('fmri TS2 response.data  =',response.data);
                $scope.lb_meg_ts2 = response.data//$scope.csv_parse_fmri(response.data); 
            },
            function (response) {
                // called asynchronously if an error occurs
                // or server returns response with an error status.
